...
# log tail and stream, dashboard/status rows, disable.
...
rm -f "$TMP/home/settings" "$TMP/home/candidates"; timeout 60 "$N" pick fast deepseek-ai/deepseek-v4-flash-0731 >/dev/null 2>&1
