...
INTERNAL=" NIMCTL_ NIMCTL_CAND_ NIMCTL_PATH_ORIG NIMCTL_WEB_BIN NIMCTL_WEB_KEYS NIMCTL_WEB_CALLER NIMCTL_CHAINS NIMCTL_HEALTH NIMCTL_CHAT_DB NIMCTL_CHAT_SEARCH NIMCTL_CHAT_BASE NIMCTL_CHAT_KEY NIMCTL_CHAT_DEFAULT NIMCTL_CHAT_SEARX NIMCTL_CHAT_RESULTS NIMCTL_CHAT_CONCURRENT NIMCTL_WORKSPACE_FILE NIMCTL_RPM_STATE NIMCTL_SEARCH_URL NIMCTL_SEARXNG_REPO NIMCTL_ACCOUNTS_ADMIN NIMCTL_ACCOUNTS_DB NIMCTL_ACCOUNTS_EMAIL NIMCTL_ACCOUNTS_HASH NIMCTL_ACCOUNTS_PW NIMCTL_MODEL_CODE NIMCTL_MODEL_FAST NIMCTL_MODEL_CHAT NIMCTL_MODEL_REVIEW "
