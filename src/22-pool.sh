...
T_de+=(
  ...
  [pool_note_groq]="~30 Anfragen/min, ~1.000/Tag, keine Karte nötig; höchstens 6–12k Tokens pro Anfrage – nur für den Chat" [pool_note_gemini]="10–15 Anfragen/min, 250–1.000/Tag; Google darf Free-Tier-Daten zum Training nutzen"
...
T_en+=(
  ...
  [pool_note_groq]="~30 requests/min, ~1,000/day, no card needed; at most 6–12k tokens per request – chat only" [pool_note_gemini]="10–15 requests/min, 250–1,000/day; Google may train on free-tier data"
